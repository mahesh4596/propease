...
-- UPDATE customers set email = 'maheshgaming4596@gmail.com' where mobile = '9779077963'; 
-- DELETE FROM customers where mobile = '9779077963';
...
-- DELETE FROM properties WHERE rid = 1;
UPDATE properties set status='Available' WHERE rid = 13;
...
SELECT * FROM deals;
-- DELETE FROM deals WHERE dealid = 9;
